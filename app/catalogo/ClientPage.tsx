      ...
      <Section id="catalog-bridge-info" variant="default" className="pb-24">
        <Container className="grid md:grid-cols-3 gap-6 max-w-6xl">
          <div className="p-6 rounded-2xl border border-border-subtle bg-bg-surface shadow-elevation-1">
            ...
            <p className="text-text-body text-sm leading-relaxed">Isolamos performance, login e segurança do catálogo B2B em infraestrutura própria.</p>
          </div>
          <div className="p-6 rounded-2xl border border-border-subtle bg-bg-surface shadow-elevation-1">
            <h3 className="text-lg font-display font-bold text-text-primary mb-2">Sem vitrine de varejo</h3>
            <p className="text-text-body text-sm leading-relaxed">Aqui não exibimos preços avulsos; toda compra passa por curadoria técnica.</p>
          </div>
          <div className="p-6 rounded-2xl border border-border-subtle bg-bg-surface shadow-elevation-1">
            <h3 className="text-lg font-display font-bold text-text-primary mb-2">Centro Técnico</h3>
            <p className="text-text-body text-sm leading-relaxed">Precisa validar CA, norma ou aplicação? Use o Centro Técnico antes de comprar.</p>
