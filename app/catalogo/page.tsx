    ...
    <main className="min-h-screen bg-white">
      ...
      <Section id="catalog-bridge-hero" variant="offwhite" className="pt-36 pb-20">
        <Container className="max-w-5xl">
          ...
          <div className="space-y-6 bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-segura-soft">
            ...
            <div className="text-sm text-slate-600 space-y-3">
              ...
              <div className="flex items-center gap-2 text-xs font-display font-bold uppercase tracking-[0.2em] text-slate-500">
                <span className="h-2 w-2 rounded-full bg-segura-primary animate-pulse" />
                {autoRedirect
            ...
            <div className="flex flex-wrap gap-3 text-xs">
              <button
                ...
                className="px-4 py-2 rounded-lg border border-segura-primary text-segura-primary font-display font-bold uppercase tracking-[0.2em] hover:bg-segura-primary hover:text-white transition-colors"
      ...
      <Section id="catalog-bridge-info" variant="default" className="pb-28">
        <Container className="grid md:grid-cols-3 gap-8 max-w-6xl">
          <div className="p-6 rounded-2xl border border-slate-200 bg-white shadow-segura-soft">
            <h3 className="text-lg font-display font-bold text-segura-dark mb-2">Por que subdomínio?</h3>
          ...
          <div className="p-6 rounded-2xl border border-slate-200 bg-white shadow-segura-soft">
            <h3 className="text-lg font-display font-bold text-segura-dark mb-2">Sem vitrine de varejo</h3>
          ...
          <div className="p-6 rounded-2xl border border-slate-200 bg-white shadow-segura-soft">
            <h3 className="text-lg font-display font-bold text-segura-dark mb-2">Centro Técnico</h3>
