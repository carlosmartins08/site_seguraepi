      ...
      <Section id="hub-hero" variant="dark" className="pt-40 pb-24 relative overflow-hidden">
        ...
        <Container>
          <div className="max-w-3xl animate-slide-up">
            ...
            <p className="text-slate-300 text-lg md:text-xl font-sans leading-relaxed">
        ...
        <Container>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-3xl bg-bg-inverse text-white p-10 flex flex-col justify-center items-start shadow-elevation-2 border border-white/5 group hover:-translate-y-2 transition-all duration-500">
              ...
              <p className="text-slate-300 text-sm mb-10 leading-relaxed font-sans">Nossos consultores utilizam dimensionamento inteligente para diagnosticar o risco do seu setor e indicar o mix ideal.</p>
