    ...
    <main id="main-content" className="bg-bg-surface min-h-screen">
      <JsonLd
        data={buildBreadcrumbJsonLd([
          ...
          { name: 'Política de Entrega e Frete', url: `${SITE_URL}${ROUTES.policyDelivery}` },
        ])}
      />
      ...
      <Section id="frete-gratis" variant="default">
        <Container className="max-w-6xl">
          <SectionTitle
            ...
            title="Custo-benefício para sua operação"
      ...
      <Section id="modalidades" variant="offwhite">
        <Container className="max-w-6xl">
          <SectionTitle
            ...
            title="Definição no momento da cotação"
      ...
      <Section id="recebimento" variant="default">
        <Container className="max-w-6xl">
          <SectionTitle
            ...
            title="Conferência no ato da entrega"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-3 text-text-body text-bodySM">
              {[
                ...
                'Comunique nosso setor de Logística no ato.',
              ].map((item) => (
