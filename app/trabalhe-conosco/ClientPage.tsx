        ...
        <Container className="max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {cultura.map((item) => (
              <div
                key={item.title}
                className="p-6 rounded-xl border border-border-muted shadow-elevation-1 bg-white flex gap-4 items-start hover:-translate-y-1 hover:shadow-glow-brand transition-all"
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-text-body leading-relaxed text-sm">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <Container className="max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {areas.map((area) => (
              <div
                key={area.title}
                className="p-6 rounded-xl border border-border-muted shadow-elevation-1 bg-white flex flex-col gap-3 hover:-translate-y-1 hover:shadow-glow-brand transition-all h-full"
              >
                <div className="w-11 h-11 rounded-xl bg-action-primary/15 text-action-primary flex items-center justify-center">
                ...
                <p className="text-text-body leading-relaxed text-sm">{area.desc}</p>
              </div>
            ))}
          </div>
        </Container>
        ...
        <Container className="max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {beneficios.map((beneficio) => (
              <div key={beneficio} className="p-5 rounded-2xl border border-border-muted shadow-elevation-1 bg-white flex items-start gap-3">
                ...
                <p className="text-text-body leading-relaxed text-sm">{beneficio}</p>
              </div>
            ))}
          </div>
        </Container>
      ...
      <Section id="candidatar" variant="offwhite">
        <Container className="max-w-5xl">
          <div className="bg-bg-inverse text-white rounded-2xl p-8 md:p-12 shadow-elevation-2 border border-white/10 space-y-6">
            <p className="text-action-primary font-display font-semibold uppercase tracking-[0.18em] text-[11px]">Como se candidatar</p>
            <h3 className="text-2xl md:text-3xl font-display font-semibold leading-tight">Quer fazer parte do time Segura EPI?</h3>
