  ...
  if (isInternal) {
    return (
      <Link
        ...
        onClick={onClick}
        className={cn(
          "text-text-primary font-sans font-semibold text-bodySM inline-flex items-center gap-2 group transition-colors hover:text-action-primaryHover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-bg-surface",
          className
        )}
        {...(rest as any)}
      >
