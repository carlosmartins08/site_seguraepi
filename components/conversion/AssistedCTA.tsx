      ...
      <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div>
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-[3px] bg-action-primary rounded-full"></div>
            <span className="text-action-primary font-display font-bold uppercase tracking-[0.3em] text-xs">Agilidade Logística</span>
          </div>
          ...
          <h2 className="text-3xl md:text-5xl font-display font-black mb-8 leading-[1.1] uppercase tracking-tight">
            ...
            <span className="text-action-primary">PROTEÇÃO INDUSTRIAL?</span>
          </h2>
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-display font-bold text-action-primary uppercase tracking-widest">Endereço Oficial</p>
