      ...
      <Container>
        <div className="grid md:grid-cols-4 gap-16 mb-20">
          <div className="md:col-span-1">
            ...
            <p className="text-slate-300 text-xs leading-relaxed font-sans mb-8">
            ...
            <div className="space-y-4">
              <a
                ...
                className="text-slate-300 text-[10px] font-display font-bold uppercase tracking-widest flex items-center gap-3 hover:text-action-primaryHover transition-colors"
              >
                <svg className="w-4 h-4 text-action-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                {CONTACT_INFO.email}
              </a>
              <a
              ...
              <a
                ...
                className="text-slate-300 text-[10px] font-display font-bold uppercase tracking-widest flex items-center gap-3 hover:text-action-primaryHover transition-colors"
              >
                <svg className="w-4 h-4 text-action-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                {CONTACT_INFO.phone}
              </a>
              <a
                ...
                className="text-slate-300 text-[10px] font-display font-bold uppercase tracking-widest flex items-center gap-3 hover:text-action-primaryHover transition-colors group"
              >
            ...
            <div className="mt-10">
              <h4 className="font-display font-bold text-[10px] uppercase tracking-[0.3em] mb-4 text-action-primary">
                {t('footer.certificationsTitle', 'Certificacoes')}
              </h4>
              <div className="grid grid-cols-2 gap-4">
                <div className="border border-white/10 p-3 rounded-xl text-center text-[9px] font-bold uppercase tracking-widest text-white/60">NR-06</div>
                <div className="border border-white/10 p-3 rounded-xl text-center text-[9px] font-bold uppercase tracking-widest text-white/60">ISO 9001</div>
              </div>
            </div>
          </div>
          <div>
            <h4 className="font-display font-bold text-[10px] uppercase tracking-[0.3em] mb-10 text-action-primary">
              {t('footer.solutionsTitle', 'Solucoes')}
            </h4>
            <ul className="space-y-5 text-[11px] text-slate-300 font-sans">
              <li><Link href={ROUTES.catalog} className="hover:text-action-primaryHover transition-colors">{t('footer.catalog', 'Catalogo completo B2B')}</Link></li>
              ...
              <li><Link href={ROUTES.center} className="hover:text-action-primaryHover transition-colors">{t('footer.center', 'Centro tecnico')}</Link></li>
              <li><Link href="/#faq" className="hover:text-action-primaryHover transition-colors">{t('footer.faq', 'FAQ')}</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-display font-bold text-[10px] uppercase tracking-[0.3em] mb-10 text-action-primary">
              {t('footer.purchaseTitle', 'Compra & Logistica')}
            </h4>
            <ul className="space-y-5 text-[11px] text-slate-300 font-sans">
              ...
              <li><Link href={ROUTES.policyDelivery} className="hover:text-action-primaryHover transition-colors">{t('footer.policyDelivery', 'Politica de entrega e frete')}</Link></li>
              <li><Link href={ROUTES.policyReturns} className="hover:text-action-primaryHover transition-colors">{t('footer.policyReturns', 'Politica de trocas e devolucoes')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-5 text-[11px] text-slate-300 font-sans">
              ...
              <li><Link href={ROUTES.privacyPolicy} className="hover:text-action-primaryHover transition-colors">{t('footer.privacy', 'Politica de privacidade')}</Link></li>
              ...
              <li>
                ...
                >
                  {t('footer.cookies', 'Preferencias de cookies')}
                </button>
              </li>
            </ul>
          </div>
          ...
          <div className="flex gap-6">
            {socialLinks.map((social) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-300 hover:text-action-primaryHover transition-all duration-300 hover:scale-110 active:scale-95 flex items-center gap-2 group"
                title={social.name}
              >
                <div className="p-2 rounded-lg bg-white/5 border border-white/5 group-hover:border-action-primary/30 transition-colors">
