        ...
        <div className="grid md:grid-cols-4 gap-16 mb-20">
          <div className="md:col-span-1">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="text-slate-400 text-[10px] font-display font-bold uppercase tracking-widest flex items-center gap-3 hover:text-action-primaryHover transition-colors"
              >
              ...
              <a
                ...
                className="text-slate-400 text-[10px] font-display font-bold uppercase tracking-widest flex items-center gap-3 hover:text-action-primaryHover transition-colors group"
              >
          ...
          <div>
            ...
            <ul className="space-y-6 text-[10px] text-slate-400 uppercase tracking-widest font-display font-bold">
              <li><Link href={ROUTES.catalog} className="hover:text-action-primaryHover transition-colors uppercase">Catalogo Completo B2B</Link></li>
              <li><Link href="/#segmentos" className="hover:text-action-primaryHover transition-colors uppercase">Segmentos Atendidos</Link></li>
              ...
              <li><Link href="/#faq" className="hover:text-action-primaryHover transition-colors uppercase">FAQ</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-6 text-[10px] text-slate-400 uppercase tracking-widest font-display font-bold">
              <li><Link href={ROUTES.about} className="hover:text-action-primaryHover transition-colors uppercase">Quem Somos</Link></li>
          ...
          <div className="flex gap-6">
            {socialLinks.map((social) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-500 hover:text-action-primaryHover transition-all duration-300 hover:scale-110 active:scale-95 flex items-center gap-2 group"
                title={social.name}
              >
