                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-12 h-[2px] bg-action-primary"></div>
                            <span className="text-action-primary font-display font-bold uppercase tracking-widest text-[10px]">Prova Social Verificada</span>
                        </div>
                    ...
                    <div className="bg-bg-inverse p-6 rounded-3xl border border-white/10 shadow-glow-brand text-white flex items-center gap-6">
                        <div className="text-center">
                            <p className="text-3xl font-display font-black">4.9</p>
                            <div className="flex gap-1 text-action-primary">
                                {[...Array(5)].map((_, i) => (
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {reviews.map((review, i) => (
                        ...
                        >
                            ...
                            <div className="flex gap-1 text-action-primary mb-6">
                            ...
                            <div className="flex items-center gap-4 border-t border-slate-200 pt-6">
                                ...
                                <div>
                                    <p className="font-display font-bold text-text-primary text-xs uppercase tracking-widest">{review.author}</p>
